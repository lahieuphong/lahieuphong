...
我目前正在从事 Web 开发相关工作，主要关注全栈开发方向。

我熟悉前端与后端开发流程，能够参与页面开发、接口对接、基础后端逻辑处理以及数据库相关工作。同时，我也会使用 AI 工具辅助编码，以提升开发效率，并持续关注代码质量与项目的可维护性。

此外，我具备一些项目部署和服务器相关的基础经验，能够进行项目部署、环境配置以及简单的服务器维护。

欢迎与我交流技术、项目合作或其他相关开发话题。
